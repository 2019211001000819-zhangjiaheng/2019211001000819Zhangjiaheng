			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<tr>
						...
						<td>${o.orderDate}</td>
						<%
							com.zhangjiaheng.model.Order o=(com.zhangjiaheng.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.zhangjiaheng.dao.UserDao userDao=new com.zhangjiaheng.dao.UserDao();
						...
						<td class="cart_total">
							<%
								...
								String paymentType=com.zhangjiaheng.model.Payment.findByPaymentId(con,n);
							%>
